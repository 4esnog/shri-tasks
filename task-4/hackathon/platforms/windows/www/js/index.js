...
var app = {
	...
	onIDBRequestError: function onIDBRequestError(e) {
		console.log('Ошибка при открытии IDB: ' + e.target.errorCode);
	},
	onIDBRequestSuccess: function onIDBRequestSuccess(e) {
		app.db = e.target.result;
		console.log('IDB открыта :)');
	},
	...
	register: function register(e) {
		...
		$.ajax('http://fantastic-hackathon.ru/action.php', {
			...
			statusCode: {
				404: function _() {
					console.log('Page not found<br />');
				},
				403: function _() {
					console.log('Forbidden<br />');
				},
				500: function _() {
					console.log('Internal server error<br />');
				},
				200: function _() {
					console.log('200 OK!<br />');
				}
			},
